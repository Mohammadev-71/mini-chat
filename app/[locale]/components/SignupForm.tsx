...
export default function SignupForm() {
    ...
    const [preview, setPreview] = useState<string>("/images/defaultProfileImg.jpeg");
    ...
    return (
        ...
        <label
            htmlFor="imgField"
            className="block w-26 h-26 bg-cover bg-center bg-no-repeat rounded-full cursor-pointer "
        ...
        <div className="flex flex-col justiy-center items-center text-indigo-800 dark:text-indigo-300">
            <p>{t("haveAccount")}</p>
            <IntLink className="text-blue-700 dark:text-blue-600" href={"/signin"}>
                {t("signinLink")}
            </IntLink>
        </div>
